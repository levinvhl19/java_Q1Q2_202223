...
public class Queue<ContentType> {
	...
	class QueueNode { // Sichtbarkeit geaendert wg. QViewer (GF) 
	...
	//-------------------------------------------------------------------------------------------------------------------------------------------
	  ...
	  /**
	   *  Folgende Hilfsmethoden dienen nur der Darstellung als QueueWithViewer, sie sind nicht Teil der Abitur-Schnittstelle (KB/BM/HO/GF)
	  */
